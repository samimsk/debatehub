...
urlpatterns = [
    ...
    url(r'^(?P<user_name>\w+)/updateuser/$', updateuser, name = 'update_user'),
    url(r'^(?P<user_name>\w+)/updateperson/$', updateperson, name = 'update_person'),
    url(r'^(?P<user_name>\w+)/updatepersondetails/$', updatepersondetails, name = 'update_person_details'),
    url(r'^(?P<user_name>\w+)/follow/$', follow, name = 'follow_user'),
    url(r'^(?P<user_name>\w+)/unfollow/$', unfollow, name = 'unfollow_user'),
